...
const GLOBAL_TAB_IDS = ['main', 'playground', 'playground2d', 'toolSets', 'toolCatalog', 'permissions', 'hooks', 'environments', 'sharedFolder', 'admin', 'settings'] as const;
...
const DEV_ONLY_GLOBAL = new Set(['toolSets', 'toolCatalog', 'permissions', 'hooks', 'environments', 'admin', 'settings']);
