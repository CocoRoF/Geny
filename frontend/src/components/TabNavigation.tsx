...
const GLOBAL_TAB_IDS = ['main', 'playground', 'playground2d', 'toolSets', 'environments', 'builder', 'sharedFolder', 'settings'] as const;
...
const DEV_ONLY_GLOBAL = new Set(['toolSets', 'environments', 'builder', 'settings']);
