...
const ko: Translations = {
  ...
  workflowsTab: {
    ...
    simpleDesc: '기본 에이전트 루프: 메모리 → 가드 → LLM 호출 → 후처리 → 종료.',
    autonomousName: '난이도 기반 자율 실행',
    autonomousDesc: '난이도 분류, 쉬움/중간/어려움 경로, 리뷰 루프, TODO 관리 및 복원력 인프라를 갖춘 그래프입니다.',
