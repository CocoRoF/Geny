...
const ko: Translations = {
  ...
  info: {
    ...
    cliAgent: {
      ...
      promptPlaceholder: '바운드 워커 시스템 프롬프트를 입력하세요...',
      noPrompt: '설정된 워커 시스템 프롬프트가 없습니다',
      notFound: '바운드 워커 세션을 로드할 수 없습니다',
    },
    thinkingTrigger: {
  ...
  createEnvironment: {
    ...
    presetVTuber: 'Geny VTuber — persona + CLI 분리',
    create: '만들기',
    creating: '만드는 중…',
    failed: '환경 생성 실패',
  },
  ...
  createSession: {
    ...
    cliPromptLabel: '바운드 워커 프롬프트',
    cliPromptHelp: 'VTuber에 바인딩된 워커의 시스템 프롬프트입니다. 코드 실행, 파일 작업 등 실무를 담당합니다.',
    cliPromptPlaceholder: '바운드 워커 추가 지시사항 (비워두면 기본 Worker 프롬프트 사용)...',
    cliModel: '바운드 워커 모델',
    cliModelHelp: '바운드 워커에 사용할 모델. 비워두면 설정의 기본 모델(Default Model)을 사용합니다.',
    cliModelSame: '기본값 (설정의 Default Model)',
    cliWorkflow: '바운드 워커 그래프 워크플로우',
    cliWorkflowHelp: '바운드 워커의 LangGraph 워크플로우. 위임된 작업을 처리하는 방식을 결정합니다.',
    cliWorkflowDefault: '기본값: Optimized Autonomous — 리뷰 루프가 포함된 다단계 작업 실행.',
    boundWorkerEnv: '바운드 워커 환경',
    boundWorkerEnvHelp: '바운드 워커가 사용할 EnvironmentManifest. 파이프라인, 스테이지 템플릿, 도구 스냅샷을 결정합니다. 비워두면 기본 WORKER 환경(template-worker-env)이 사용됩니다.',
    boundWorkerEnvDefault: '기본값 — template-worker-env',
    boundWorkerEnvDefaultHelp: '기본 WORKER 환경(template-worker-env)을 사용합니다.',
    creating: '생성 중...',
    createSession: '세션 생성',
