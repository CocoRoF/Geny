...
const en = {
  ...
  info: {
    ...
    cliAgent: {
      ...
      promptPlaceholder: 'Enter bound Worker system prompt...',
      noPrompt: 'No Worker system prompt configured',
      notFound: 'Bound Worker session could not be loaded',
    },
    thinkingTrigger: {
  ...
  createEnvironment: {
    ...
    presetVTuber: 'Geny VTuber — persona + CLI split',
    create: 'Create',
    creating: 'Creating…',
  ...
  createSession: {
    ...
    cliPromptLabel: 'Bound Worker Prompt',
    cliPromptHelp: 'System prompt for the Worker bound to this VTuber. Handles code execution, file operations, etc.',
    cliPromptPlaceholder: 'Bound Worker additional instructions (leave empty for default Worker prompt)...',
    cliModel: 'Bound Worker Model',
    cliModelHelp: 'Model for the bound Worker. If left empty, uses the Default Model from settings.',
    cliModelSame: 'Default (from Settings)',
    cliWorkflow: 'Bound Worker Graph Workflow',
    cliWorkflowHelp: 'The LangGraph workflow for the bound Worker. Determines how the Worker processes delegated tasks.',
    cliWorkflowDefault: 'Default: Optimized Autonomous — multi-step task execution with review loops.',
    boundWorkerEnv: 'Bound Worker Environment',
    boundWorkerEnvHelp: 'EnvironmentManifest for the bound Worker. Controls pipeline, stage templates, and tool snapshot. Leave blank to use the default WORKER environment (template-worker-env).',
    boundWorkerEnvDefault: 'Default — template-worker-env',
    boundWorkerEnvDefaultHelp: 'Uses the default WORKER environment (template-worker-env).',
    creating: 'Creating...',
