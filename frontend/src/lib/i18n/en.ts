...
const en = {
  ...
  settings: {
    ...
    models: {
      ...
      addKey: 'Add an account',
      accountCount: '{n}',
      orderHint: 'The account at the top answers. The next one is tried only when it cannot.',
      orderEmpty: 'No account is switched on — add one below.',
      baseUrl: 'Address',
      secret: 'API key',
  ...
  info: {
    persona: {
      ...
      title: 'Persona',
      followRole: 'Follow the role default',
  ...
  voiceStudio: {
    ...
    harness: {
      ...
      section: {
        budgets: 'Limits',
        budgetsHint: 'How far this agent may go in one turn.',
        basic: 'The common ones',
        basicHint: 'The eight that actually change how the agent behaves.',
        advanced: 'Advanced',
        advancedHint: 'Change these knowing what a pipeline stage is. A wrong choice can fail a turn.',
        locked: 'Not settings',
        lockedHint: 'What Geny is, rather than how it is configured. Shown rather than hidden, and inert.',
      },
      source: {
        default: 'default',
        manifest: 'pipeline',
      ...
      budget: {
        maxIterations: 'Maximum steps in one turn',
        maxIterationsHint: 'How many times it may use a tool and read the result. The number here is the number that runs.',
        contextWindow: 'Context window',
        contextWindowHint: 'Once the conversation fills this much, the earlier part is summarised. Blank follows the smallest model in the route.',
        contextWindowPerHop: 'Each model in the route: {hops}. The smallest one binds.',
        costCeiling: 'Spend ceiling per turn',
        costCeilingHint: '0 means no ceiling. Only spend a backend reports can be counted, so a subscription login is never stopped by it.',
      },
      question: {
        ...
        delegation: 'May it hand work to another agent',
      ...
      locked: {
        ...
        routeDecides: 'Which model answers is the route\'s decision. Deciding it again here would put a second answer on the page.',
        onlyOption: 'There is only one option.',
      },
      installed: {
        persistingCompactor: 'Files each summary in the agent\'s memory as it makes it.',
        memoryAware: 'Pulls this agent\'s memory into the turn.',
      ...
      stage: {
        input: 'input', context: 'context', system: 'system', guard: 'guard', cache: 'cache',
        api: 'call', token: 'token', think: 'think', parse: 'parse', tool: 'tool',
        tool_review: 'tool review', agent: 'delegate', task_registry: 'tasks',
        evaluate: 'evaluate', hitl: 'approval', loop: 'loop', emit: 'emit',
        memory: 'memory', summarize: 'summarize', persist: 'persist', yield: 'yield',
      },
    },
    settings: {
      engines: {
