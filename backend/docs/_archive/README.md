...
Geny backend 가 LangGraph `StateGraph` + 커스텀 노드 시스템으로 운영되던 시기 (2025~2026-03) 의 13 쌍 = 26 파일. 2026-04 `geny-executor` Pipeline 도입으로 전면 대체됨.
...
**대체 문서:** 현재 실행 흐름은 [`../EXECUTION.md`](../EXECUTION.md), [`../SESSIONS.md`](../SESSIONS.md), [`../WORKFLOW.md`](../WORKFLOW.md) 를 참조.
