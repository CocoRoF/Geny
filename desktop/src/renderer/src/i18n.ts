...
export const messages: Record<string, Entry> = {
  ...
  'file.binary': { ko: '글자로 읽을 수 없는 파일입니다', en: 'This file is not text' },
  'explorer.title': { ko: '탐색기', en: 'Explorer' },
  'explorer.noSession': { ko: '세션을 고르면 그 작업 공간이 보입니다', en: 'Pick a session to see its workspace' },
  'explorer.empty': { ko: '아직 파일이 없습니다', en: 'No files yet' },
