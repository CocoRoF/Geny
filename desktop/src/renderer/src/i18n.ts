...
//
// Every user-facing string in the renderer (the app, its settings tab, the chip…)
...
export const messages: Record<string, Entry> = {
  ...
  'chat.voice.tts': { ko: '음성 출력', en: 'Voice' },
  'chat.voice.tts.hint': { ko: '답을 아바타 목소리로 읽어 줍니다', en: "Replies are spoken in the avatar's voice" },
  'chat.voice.stt': { ko: '음성 입력', en: 'Mic' },
  'chat.voice.stt.hint': { ko: '마이크가 듣고, 말한 내용을 대화에 공유합니다', en: 'The microphone listens and shares what you say' },
  'chat.voice.ptt': { ko: '말하기', en: 'Talk' },
  'chat.voice.ptt.hint': { ko: '누르면 듣기 시작, 다시 누르면 보냅니다. 말하는 중이면 끊고 듣습니다', en: 'Press to start talking, press again to send. Interrupts the avatar if it is speaking' },
  'chat.voice.realtime': { ko: '핸즈프리', en: 'Hands-free' },
  'chat.voice.realtime.hint': { ko: '말하고 멈추면 바로 답합니다. 버튼 없이 대화하듯', en: 'Talk, pause, and it answers. A conversation without buttons' },
  ...
  'chat.voice.speaking': { ko: '말하는 중', en: 'Speaking' },
  'chat.voice.listening': { ko: '듣는 중', en: 'Listening' },
  'chat.voice.readAloud': { ko: '소리 내어 읽기', en: 'Read aloud' },
  'chat.attach.button': { ko: '이미지·문서·오디오 파일을 첨부합니다 (붙여넣기, 끌어다 놓기도 됩니다)', en: 'Attach images, documents or audio (paste and drag-and-drop work too)' },
  'chat.attach.short': { ko: '첨부', en: 'Attach' },
  'chat.attach.screen': { ko: '화면 첨부', en: 'Screenshot' },
  'chat.attach.screenHint': { ko: '지금 화면을 찍어 메시지에 붙입니다', en: 'Capture the screen now and attach it' },
  'chat.attach.grabbing': { ko: '찍는 중', en: 'Capturing' },
  'chat.attach.drop': { ko: '여기에 놓으면 첨부됩니다', en: 'Drop to attach' },
  'chat.attach.limit': { ko: '한 번에 {n}개까지 첨부할 수 있습니다', en: 'Up to {n} files per message' },
  'chat.attach.failed': { ko: '올리지 못했습니다', en: 'Upload failed' },
  'chat.attach.uploading': { ko: '올리는 중', en: 'Uploading' },
  'chat.attach.remove': { ko: '빼기', en: 'Remove' },
  'chat.attach.waiting': { ko: '파일을 다 올린 뒤 보낼 수 있습니다', en: 'Sends once the files finish uploading' },
  'set.title': { ko: '설정', en: 'Settings' },
  'set.cancel': { ko: '취소', en: 'Cancel' },
  'set.open': { ko: '열기', en: 'Open' },
  'set.loading': { ko: '불러오는 중', en: 'Loading' },
  'set.noBridge': { ko: '앱 밖에서 열린 화면이라 설정을 바꿀 수 없습니다.', en: 'This screen is open outside the app, so settings cannot be changed.' },
  'set.needsAccount': { ko: '로그인하면 쓸 수 있는 설정입니다.', en: 'Sign in to use these settings.' },
  'set.toAccount': { ko: '계정에서 로그인', en: 'Sign in from Account' },
  'set.signedOut.title': { ko: '로그인이 필요합니다', en: 'Sign in to continue' },
  'set.signedOut.body': { ko: 'Geny 서버에 로그인하면 에이전트와 대화하고, 아바타를 띄우고, 작업을 볼 수 있습니다.', en: 'Sign in to your Geny server to talk to your agents, bring up the avatar and follow their work.' },
  'set.signedOut.action': { ko: '로그인하러 가기', en: 'Go to sign in' },
  'set.signedOut.sidebar': { ko: '로그인하면 세션이 여기에 보입니다.', en: 'Sign in to see your sessions here.' },
  'set.tab.account': { ko: '계정', en: 'Account' },
  'set.tab.general': { ko: '일반', en: 'General' },
  'set.tab.models': { ko: '모델', en: 'Models' },
  'set.tab.voice': { ko: '음성', en: 'Voice' },
  'set.tab.screen': { ko: '화면 관찰', en: 'Screen' },
  'set.tab.control': { ko: '로컬 제어', en: 'Local control' },
  'set.tab.drive': { ko: '드라이브', en: 'Drive' },
  'set.tab.mcp': { ko: 'MCP', en: 'MCP' },
  'set.desc.account': { ko: '이 앱이 연결할 Geny 서버와 로그인한 계정입니다.', en: 'The Geny server this app connects to, and the account you are signed in with.' },
  'set.desc.general': { ko: '테마와 언어, 시작과 업데이트, 문제가 생겼을 때 쓰는 도구입니다.', en: 'Theme and language, startup and updates, and tools for when something goes wrong.' },
  'set.desc.models': { ko: '에이전트가 쓰는 모델 계정입니다. 켜진 계정을 위에서부터 차례로 씁니다.', en: 'The model accounts your agents use. Enabled accounts are tried from the top down.' },
  'set.desc.voice': { ko: '아바타가 말하고 듣는 방식입니다. 음성 켜고 끄기는 채팅 창과 아바타 칩에 있습니다.', en: 'How the avatar speaks and listens. Turning voice on and off is in the chat and on the avatar\'s chip.' },
  'set.desc.screen': { ko: '화면 관찰을 켰을 때 아바타가 무엇을, 얼마나 자주 보는지입니다.', en: 'What the avatar looks at, and how often, while screen observation is on.' },
  'set.desc.control': { ko: '에이전트가 이 컴퓨터를 직접 다룰 수 있는지, 어디까지인지 정합니다.', en: 'Whether the agent may act on this computer, and how far.' },
  'set.desc.drive': { ko: '이 컴퓨터의 Geny 클라우드 폴더와, 거기에 연결한 폴더입니다.', en: 'This computer\'s Geny cloud folder, and the folders linked into it.' },
  'set.desc.mcp': { ko: '이 컴퓨터에서 도는 MCP 서버의 도구를 에이전트가 쓸 수 있게 합니다.', en: 'Lets the agent use tools from MCP servers running on this computer.' },
  'set.hotkey.recording': { ko: '키 조합을 누르세요 (Esc 취소)', en: 'Press a key combination (Esc to cancel)' },
  'set.hotkey.idle': { ko: '눌러서 키 조합 정하기', en: 'Click to set a key combination' },
  'set.hotkey.registered': { ko: '단축키를 등록했습니다.', en: 'Shortcut registered.' },
  'set.hotkey.conflict': { ko: '다른 앱이 쓰는 조합입니다. 다른 조합을 골라 주세요.', en: 'Another app uses this combination. Choose a different one.' },
  'set.account.server': { ko: '서버', en: 'Server' },
  'set.account.serverHint': { ko: 'Geny 서버의 주소입니다. 예: https://geny.example.com', en: 'The address of your Geny server, for example https://geny.example.com' },
  'set.account.saveUrl': { ko: '저장', en: 'Save' },
  'set.account.switchServer': { ko: '바꾸고 로그아웃', en: 'Change and sign out' },
  'set.account.switchWarn': { ko: '다른 서버로 바꾸면 지금 계정에서 로그아웃됩니다.', en: 'Switching servers signs you out of this account.' },
  'set.account.connection': { ko: '연결 상태', en: 'Connection' },
  'set.account.noServer': { ko: '서버 주소를 입력하세요.', en: 'Enter the server address.' },
  'set.account.web': { ko: '웹에서 열기', en: 'Open on the web' },
  'set.account.webHint': { ko: '브라우저에서 Geny 웹 화면을 엽니다.', en: 'Opens the Geny web app in your browser.' },
  'set.account.account': { ko: '계정', en: 'Account' },
  'set.account.signedIn': { ko: '로그인됨', en: 'Signed in' },
  'set.account.signedInHint': { ko: '{host} 에 로그인되어 있습니다. 로그인 정보는 이 컴퓨터의 보안 저장소에 있습니다.', en: 'Signed in to {host}. Your sign-in is kept in this computer\'s secure storage.' },
  'set.account.logoutConfirm': { ko: '로그아웃', en: 'Sign out' },
  'set.account.signIn': { ko: '로그인', en: 'Sign in' },
  'set.account.signInHint': { ko: 'Geny 서버의 계정으로 로그인합니다.', en: 'Sign in with your account on the Geny server.' },
  'set.general.look': { ko: '화면', en: 'Appearance' },
  'set.general.themeHint': { ko: '시스템을 고르면 운영체제 설정을 따라갑니다.', en: 'System follows your operating system\'s setting.' },
  'set.general.langHint': { ko: '앱과 트레이 메뉴의 언어입니다.', en: 'The language of the app and its tray menu.' },
  'set.general.quickChat': { ko: '빠른 대화', en: 'Quick chat' },
  'set.general.quickChatKey': { ko: '빠른 대화 열기', en: 'Open quick chat' },
  'set.general.quickChatHint': { ko: '어느 화면에서든 이 키를 누르면 아바타의 VTuber에게 바로 말을 걸 수 있습니다.', en: 'Press this anywhere to talk to the avatar\'s VTuber right away.' },
  'set.general.startup': { ko: '시작', en: 'Startup' },
  'set.general.autostartHint': { ko: '컴퓨터에 로그인하면 Geny가 트레이에서 조용히 시작합니다.', en: 'Geny starts quietly in the tray when you sign in to your computer.' },
  'set.general.update': { ko: '업데이트', en: 'Updates' },
  'set.general.version': { ko: '지금 버전 v{v}', en: 'Current version v{v}' },
  'set.general.checkHint': { ko: '새 버전이 있으면 내려받아 설치하고 다시 시작합니다.', en: 'If there is a new version, it downloads, installs and restarts.' },
  'set.general.check': { ko: '업데이트 확인', en: 'Check for updates' },
  'set.general.checking': { ko: '업데이트를 확인하고 있습니다. 결과는 알림 창으로 알려 드립니다.', en: 'Checking for updates. The result will appear in a dialog.' },
  'set.general.trouble': { ko: '문제 해결', en: 'Troubleshooting' },
  'set.general.positionsHint': { ko: '창이나 아바타가 화면 밖으로 사라졌을 때 기본 위치로 되돌립니다.', en: 'Brings windows and the avatar back to their default places if they went off screen.' },
  'set.general.reset': { ko: '되돌리기', en: 'Reset' },
  'set.general.restart': { ko: '앱 다시 시작', en: 'Restart the app' },
  'set.general.restartHint': { ko: '아바타와 모든 창을 닫았다가 다시 엽니다.', en: 'Closes and reopens the avatar and every window.' },
  'set.general.restartNow': { ko: '다시 시작', en: 'Restart' },
  'set.general.debugHint': { ko: '로그인이나 아바타, 연결에 문제가 있을 때 이 기록을 복사해 전달해 주세요.', en: 'If sign-in, the avatar or the connection misbehaves, copy this log and send it along.' },
  'set.general.debugLoad': { ko: '기록 불러오기', en: 'Load log' },
  'set.models.add': { ko: '키 추가', en: 'Add key' },
  'set.models.addLogin': { ko: '계정 추가', en: 'Add account' },
  'set.models.up': { ko: '위로', en: 'Move up' },
  'set.models.down': { ko: '아래로', en: 'Move down' },
  'set.models.enabled': { ko: '사용', en: 'Enabled' },
  'set.models.removeConfirm': { ko: '삭제', en: 'Remove' },
  'set.models.testOk': { ko: '응답함 · {ms}ms', en: 'Answered · {ms}ms' },
  'set.models.testFail': { ko: '응답하지 않았습니다.', en: 'Did not answer.' },
  'set.voice.talk': { ko: '말하기', en: 'Talking' },
  'set.voice.pttKey': { ko: '말하기 단축키', en: 'Talk shortcut' },
  'set.voice.pttHint': { ko: '누르면 마이크가 듣기 시작하고, 다시 누르면 보냅니다. 아바타가 말하는 중이면 끊고 듣습니다.', en: 'Press to start listening, press again to send. Interrupts the avatar if it is speaking.' },
  'set.voice.out': { ko: '음성 출력', en: 'Voice output' },
  'set.voice.volumeHint': { ko: '아바타 목소리의 크기입니다.', en: 'How loud the avatar\'s voice is.' },
  'set.voice.outputHint': { ko: '아바타 목소리를 낼 스피커입니다.', en: 'The speaker the avatar\'s voice comes out of.' },
  'set.voice.in': { ko: '음성 입력', en: 'Voice input' },
  'set.voice.inputHint': { ko: '아바타가 들을 마이크입니다.', en: 'The microphone the avatar listens with.' },
  'set.voice.sensitivity': { ko: '민감도', en: 'Sensitivity' },
  'set.voice.sensitivityHint': { ko: '낮을수록 작은 소리도 말로 알아듣습니다.', en: 'Lower values pick up quieter speech.' },
  'set.voice.silenceHint': { ko: '말을 멈춘 뒤 이만큼 조용하면 말이 끝난 것으로 봅니다.', en: 'How long a pause ends what you are saying.' },
  'set.voice.echoHint': { ko: '스피커 소리가 마이크로 다시 들어가지 않게 합니다.', en: 'Keeps the speaker\'s sound out of the microphone.' },
  'set.voice.noiseHint': { ko: '주변 잡음을 줄입니다.', en: 'Reduces background noise.' },
  'set.voice.gainHint': { ko: '목소리 크기를 자동으로 맞춥니다.', en: 'Evens out how loud your voice comes through.' },
  'set.voice.subtitles': { ko: '자막', en: 'Captions' },
  'set.voice.subtitlesHint': { ko: '아바타 아래에 하는 말을 글로 보여 줍니다.', en: 'Shows what the avatar says as text beneath it.' },
  'set.voice.speedHint': { ko: '글자가 나타나는 속도입니다.', en: 'How fast the letters appear.' },
  'set.voice.deviceAway': { ko: '연결 안 됨', en: 'Not connected' },
  'set.screen.watch': { ko: '화면 관찰', en: 'Screen observation' },
  'set.screen.watchHint': { ko: '켜고 끄기는 채팅 창과 아바타 칩에 있습니다.', en: 'Turning it on and off is in the chat and on the avatar\'s chip.' },
  'set.screen.intervalHint': { ko: '아바타가 화면을 한 번 보는 간격입니다.', en: 'How often the avatar looks at the screen.' },
  'set.screen.kindScreen': { ko: '화면', en: 'Screen' },
  'set.screen.kindWindow': { ko: '창', en: 'Window' },
  'set.screen.gone': { ko: '닫힌 창', en: 'Closed window' },
  'set.screen.noSources': { ko: '볼 수 있는 화면이 없습니다. 화면 보기가 허용되어 있는지 확인해 주세요.', en: 'No screens are available. Check that screen viewing is allowed.' },
  'set.control.desc': { ko: '켜면 에이전트가 이 컴퓨터의 화면을 보고, 입력하고, 앱을 다룰 수 있습니다. 아래에서 하나씩 허용합니다.', en: 'When on, the agent can see this computer\'s screen, type and work with apps. Allow each one below.' },
  'set.control.screenHint': { ko: '화면을 찍고 열린 창 목록을 봅니다. 보기만 합니다.', en: 'Captures the screen and lists open windows. Read only.' },
  'set.control.inputHint': { ko: '키보드 입력과 마우스 클릭을 합니다.', en: 'Types and clicks.' },
  'set.control.appsHint': { ko: '앱을 열고 버튼과 입력칸을 다루며, Office 문서를 편집합니다.', en: 'Opens apps, works their controls and edits Office documents.' },
  'set.control.clipboardHint': { ko: '클립보드에 글을 넣습니다.', en: 'Puts text on the clipboard.' },
  'set.control.browserHint': { ko: '자동화 전용 Chrome이나 Edge 창에서 웹 페이지를 다룹니다.', en: 'Works web pages in a dedicated Chrome or Edge window.' },
  'set.control.consent.ask': { ko: '할 때마다 이 컴퓨터에서 허락을 묻습니다.', en: 'Asks on this computer every time.' },
  'set.control.consent.session': { ko: '한 번 허락하면 앱을 다시 시작할 때까지 묻지 않습니다.', en: 'Once allowed, it does not ask again until the app restarts.' },
  'set.control.consent.auto': { ko: '묻지 않고 바로 합니다. 믿을 수 있는 에이전트에만 쓰세요.', en: 'Acts without asking. Use only with agents you trust.' },
  'set.drive.nativeHint': { ko: '탐색기에서 드라이브처럼 보이게 연결합니다.', en: 'Mounts it so it shows up like a drive in your file manager.' },
  'set.drive.unlinkConfirm': { ko: '연결 해제', en: 'Unlink' },
  'set.mcp.servers': { ko: '서버', en: 'Servers' },
  'set.mcp.failed': { ko: '연결 실패', en: 'Failed to connect' },
  'set.mcp.removeConfirm': { ko: '삭제', en: 'Remove' },
  'set.mcp.name': { ko: '이름', en: 'Name' },
  'set.mcp.transport': { ko: '연결 방식', en: 'Transport' },
  'set.mcp.stdio': { ko: '명령 실행 (stdio)', en: 'Command (stdio)' },
  'set.mcp.command': { ko: '실행할 명령', en: 'Command' },
  'set.mcp.test': { ko: '연결 테스트', en: 'Test connection' },
  'set.mcp.naming': { ko: '에이전트에게는 mcp_<서버>_<도구> 이름으로 보입니다.', en: 'The agent sees each tool as mcp_<server>_<tool>.' },
